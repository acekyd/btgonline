  ...
  <div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm">
      ...
      >
        <template #cell-is_active="{ value }">
          <AppBadge :variant="value ? 'active' : 'inactive'">{{ value ? 'Active' : 'Inactive' }}</AppBadge>
        </template>
    ...
    <AppModal v-model="showDeleteModal" title="Delete Creator">
      <p class="text-gray-600 dark:text-gray-300 text-sm">
        ...
        <span class="font-semibold text-gray-900 dark:text-white">{{ deletingCreator?.display_name }}</span>?
